...
public class BlueChat_Welcome extends ActionBarActivity {
 ...
 public void onClick(View v)
    {
    	...
    	Intent intent = new Intent(BlueChat_Welcome.this,BlueChat_ProfileBuilder.class);
 ...
 @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.blue_chat__welcome, menu);
        return true;
    }
